...
if (window.location.pathname == '../../views/collages/edit') {
  ...
  const giphySearch = () => {
    ...
    const query = document.querySelector('.nested-fields #giphy-query').value;
  ...
  gifSubmit.addEventListener('click', (event) => {
